...
public class SQLQueries {
    ...
    public static final String DELETE_PRESCRIBED_MEDICATIONS = "delete pm from prescribed_medications 'pm' join medical_records 'mr' on pm.record_id = mr.record_id where mr.patient_id = :id";
