package com.hospital_spring.dao.respositories.statiC;
...
@Repository
@Profile("statiC")
public class StaticCredentialRepository implements com.hospital_spring.dao.respositories.CredentialRepository {
