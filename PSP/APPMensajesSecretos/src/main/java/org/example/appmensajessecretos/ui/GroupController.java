        ...
        switch (error) {
            ...
            case ServiceError e -> {
                switch (e) {
                    ...
                    case MESSAGE_NOT_SIGNED -> errorMessage = Constantes.MESSAGE_NOT_SIGNED;
                    case ERROR_SIGNING -> errorMessage = Constantes.ERROR_SIGNING;
                    case ERROR_VERIFYING -> errorMessage = Constantes.ERROR_VERIFIYING;
                }
            }
