...
public class Constantes {
    ...
    public static final String CREACION_USUARIO = "Creacion usuario:";
    public static final String CREACION_GRUPO = "Creacion grupo:";
    ...
    public static final String ERROR_CREATING_GROUP = "No se ha podido crear el grupo, compruebe los datos e intentelo de nuevo";
