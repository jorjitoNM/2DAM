...
public abstract class Hilt_EventDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EventDetailsFragment() {
    super();
  }

  Hilt_EventDetailsFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EventDetailsFragment_GeneratedInjector) this.generatedComponent()).injectEventDetailsFragment(UnsafeCasts.<EventDetailsFragment>unsafeCast(this));
    }
  }
