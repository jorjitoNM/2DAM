...
public abstract class Hilt_TodosListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TodosListFragment() {
    super();
  }

  Hilt_TodosListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TodosListFragment_GeneratedInjector) this.generatedComponent()).injectTodosListFragment(UnsafeCasts.<TodosListFragment>unsafeCast(this));
    }
  }
