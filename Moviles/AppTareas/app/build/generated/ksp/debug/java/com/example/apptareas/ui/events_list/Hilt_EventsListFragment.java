...
public abstract class Hilt_EventsListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EventsListFragment() {
    super();
  }

  Hilt_EventsListFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EventsListFragment_GeneratedInjector) this.generatedComponent()).injectEventsListFragment(UnsafeCasts.<EventsListFragment>unsafeCast(this));
    }
  }
