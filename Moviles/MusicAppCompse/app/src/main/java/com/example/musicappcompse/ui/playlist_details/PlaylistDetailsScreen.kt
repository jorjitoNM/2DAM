...
fun PlaylistDetailsScreen(
    ...
    PlaylistDetailsContent(
        ...
        updatePlaylist = { playlistDetailsViewModel.handleEvent(PlaylistDetailsEvents.UpdatePlaylist(uiState.playlist.playlist)) }
    )
}

@Composable
fun PlaylistDetailsContent(
    playlist: PlaylistWithSongs = PlaylistWithSongs(),
    ...
    Column(
        ...
        Row(
            ...
            Column(
                ...
                Text("ID: " + playlist.playlist.playlistId, color = MaterialTheme.colorScheme.secondary)
            }
            Column(
                modifier = Modifier
                    .weight(0.8f)
...
fun PlaylistDetailsScreenPreview(
    ...
    PlaylistDetailsContent(
        playlist = PlaylistWithSongs(
            playlist = Playlist(1, "This is Kendrick Lamar"),
            songs = listOf(
